...
if len(l_neg) > 0 :
    ...
    print ( f'The sum of the negative values is     : {sum(l_neg):6}')
    print ( f'The average of the negative values is : {s.mean(l_neg):8.2}')
else :
...
if len(l_pos) > 0 :
    ...
    print ( f'The sum of the positive values is     : {sum(l_pos):6}')
    print ( f'The average of the positive values is : {s.mean(l_pos):8.2}')
else :
