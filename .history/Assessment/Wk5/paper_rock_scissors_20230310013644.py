...
print ( "-" * 35 )
print ( f'{"Player":10} {"Comrrputer":10} {"Result":10}')
print ( "=" * 10 + "=" * 10 + "=" * 10 )
while (player_score < 3 and computer_score < 3):
    ...
    print ( f'{p_play_name:10} {c_play_name:10}', end = " ")
...
if player_score == int(3) :
    print ( f"Congratulations you won by {player_score} to {computer_score}")
else:
    print ( f"Better luck next time, the computer beat you by {computer_score} to {player_score}")
